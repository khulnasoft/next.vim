local Network = require("vim-insight.reporter.network-reporter")
local File = require("vim-insight.reporter.file-reporter")
local Memory = require("vim-insight.reporter.memory-reporter")
...
local default_data_path = string.format("%s/vim-insight.json", data_path)
