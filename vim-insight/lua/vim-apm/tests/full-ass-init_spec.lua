...
local APMBussin = require("vim-insight.bus")
local Events = require("vim-insight.event_names")
local FauxKey = require("vim-insight.tests.faux-key")
local Stats = require("vim-insight.stats")
...
describe("APM", function()
    ...
    before_each(function()
        pcall(vim.loop.fs_unlink, "/tmp/vim-insight.json")
        apm:clear()

        local buffer = vim.fn.bufnr("lua/vim-insight/tests/test-file", true)
    ...
    it(
        ...
        function()
            ...
            local file = vim.loop.fs_open("/tmp/vim-insight.json", "w", 493)
