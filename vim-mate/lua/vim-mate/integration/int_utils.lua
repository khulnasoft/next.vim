local utils = require("vim-mate.utils")
local system = vim.system or require("vim-mate.system")
...
local khulnasoft = load("lua/vim-mate/integration/khulnasoft")
local khulnasoft_partial = load("lua/vim-mate/integration/khulnasoft.partial")
local empty = load("lua/vim-mate/integration/empty")
