...
func machineCreateUrl() string {
    return fmt.Sprintf("%s/v1/apps/arcadevim/machines", BASE_URL)
}
...
func createMachine() (*MachineCreateResponse, error) {
	body := []byte(`{
      "config": {
        "image": "registry.fly.io/arcadevim:deployment-01J6XBCR5F95VZAH6REWNP2XBC",
        "env": {
          "APP_ENV": "production"
        },
        "services": [
