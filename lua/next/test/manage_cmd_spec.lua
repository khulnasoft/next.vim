...
describe("basic functionalities", function()
    ...
    it("add_cmd for empty", function()
        ...
        assert_table_equals(next.get_term_config().cmds, expected_result)
    ...
    it("set_cmd_list", function()
        ...
        assert_table_equals(expected_result, next.get_term_config().cmds)
    end)
end)
