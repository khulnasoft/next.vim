...
local Events = require("next-apm.event_names")
local FauxKey = require("next-apm.tests.faux-key")
local Stats = require("next-apm.stats")
...
describe("APM", function()
    ...
    before_each(function()
        pcall(vim.loop.fs_unlink, "/tmp/next-apm.json")
        apm:clear()

        local buffer = vim.fn.bufnr("lua/next-apm/tests/test-file", true)
    ...
    it(
        ...
        function()
            ...
            local file = vim.loop.fs_open("/tmp/next-apm.json", "w", 493)
